...
#define BALANCE_FALL_START_X100 80
...
#define BALANCE_AUTO_BIAS_ENABLE 0
#define BALANCE_DRIFT_SPEED     600
#define BALANCE_DRIFT_POSITION  7000
#define BALANCE_DRIFT_PUSH_LIMIT 900
#define BALANCE_DRIFT_RECENTER_ANGLE_X100 600
#define BALANCE_DRIFT_PULL_PWM  700
#define BALANCE_KICK_ANGLE_X100 180
#define BALANCE_KICK_SPEED      450
#define BALANCE_KICK_PWM        5200
#define BALANCE_KICK_TICKS      18
#define BALANCE_RECOVER_TICKS   90
#define BALANCE_RECOVER_SPEED_KP 0.70f
#define BALANCE_KICK_COOLDOWN_TICKS 120
